...
namespace Web.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public AccountsController(UserManager<User> userManager, IMapper mapper, JwtHandler jwtHandler, ISender emailSender)
        {
        ...
        public async Task<IActionResult> RegisterUser([FromBody] UserForRegistrationDto userForRegistration)
        {
            ...
            var message = new Message(new string[] { "karlneumann699@gmail.com" }, "Email Confirmation token", callback, null);
        ...
        public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordDto forgotPasswordDto)
        {
            ...
            var message = new Message(new string[] { "karlneumann699@gmail.com" }, "Reset password token", callback, null);
            await _emailSender.SendEmailAsync(message);
